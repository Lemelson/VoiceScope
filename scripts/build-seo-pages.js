...
const pages = [
  ...
  },
  {
    ...
    sections: [
      ["1. Audio capture", `<p>The browser requests a microphone stream with local background-noise suppression. Echo cancellation and automatic gain control remain disabled so they do not reshape the pitch signal. PCM samples are captured locally and downsampled to approximately 16 kHz for analysis.</p>`],
