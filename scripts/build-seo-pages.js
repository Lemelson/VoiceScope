...
const pages = [
  ...
  },
  {
    ...
    sections: [
      ...
      ["3. Acceptance and correction", `<p>Frames outside the configured frequency range or below detector confidence are rejected. An adaptive filter removes quiet, persistent background-tone readings only when louder or more reliable voice evidence is present. Local octave correction tests brief 2× or ½× errors against unchanged neighbours on both sides.</p>`],
